...
public class ThemeUtils {
    ...
    public static int getThemeAttrColor(Context context, int attr) {
        TEMP_ARRAY[0] = attr;
        androidx.appcompat.widget.TintTypedArray a = androidx.appcompat.widget.TintTypedArray.obtainStyledAttributes(context, null, TEMP_ARRAY);
        try {
    ...
    public static ColorStateList getThemeAttrColorStateList(Context context, int attr) {
        TEMP_ARRAY[0] = attr;
        androidx.appcompat.widget.TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, null, TEMP_ARRAY);
        try {
